...
public class MapsActivity extends FragmentActivity {
    ...
    private float getDistanceInMiles(LatLng p1, LatLng p2) {

        double lat1 = (p1.latitude) / 1e6;
        double lng1 = (p1.longitude) / 1e6;
        double lat2 = (p2.latitude) / 1e6;
        double lng2 = (p2.longitude) / 1e6;
    ...
    private void getLastKnownLocation() {
        locationManagerR = (LocationManager) getApplicationContext().getSystemService(LOCATION_SERVICE);
        List<String> providers = locationManagerR.getProviders(true);
        ...
        for (String provider : providers) {
            ...
            Location l = locationManagerR.getLastKnownLocation(provider);
            if (l == null) {
                continue;
            }
